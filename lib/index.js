...
module.exports = function (content) {
  ...
  const str = `
  import script from "${filePath}?reactvue&type=script&lang=js&"
  export * from "${filePath}?reactvue&type=script&lang=js&"
  import style0 from ${filePath}?reactvue&type=style&index=0&lang=${lang}&"
  `
